export const DEMO_DATA = {
  ...
  analysis: {
    ...
    // answers 用问题原文逐字做 key 查答案，改上面 suggestedQuestions 的文案时
    // 必须同步改这里的 key，否则点击追问按钮会查不到对应答案（静默 fallback 到 defaultAnswer）
    answers: {
...
} as const; // as const 让所有字段变成只读字面量类型，下面才能直接从数据反推出精确类型
